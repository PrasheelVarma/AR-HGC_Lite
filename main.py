...
def main() -> None:
    ...
    print("[INFO] Started. Gestures:")
    print("       INDEX EXTENDED → MOVE cursor")
    print("       PINCH (index+thumb) → LEFT CLICK  (0.4 s debounce)")
    print("       FIST → CLUTCH / IDLE  (freeze cursor)")
    ...
    while True:
        ...
        cv2.imshow("Hand Gesture Mouse  [Q/ESC = quit]", frame)
